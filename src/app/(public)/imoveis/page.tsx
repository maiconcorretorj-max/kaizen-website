      ...
      <div className="bg-gradient-to-br from-[#0A2A66] to-[#1E4ED8] py-16">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">Nossos Imóveis</h1>
            <p className="text-blue-100 text-lg">Encontre o imóvel ideal entre nossa seleção de propriedades</p>
          </div>
        </div>
      </div>
